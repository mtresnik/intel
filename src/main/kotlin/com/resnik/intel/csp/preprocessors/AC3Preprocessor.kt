...
class AC3Preprocessor<VAR, DOMAIN> : CSPPreprocessor<VAR, DOMAIN>() {
    ...
    override fun preprocess(csp: CSPBase<VAR, DOMAIN>) {
        ...
        variables.forEach { variable ->
            unaryConstraints[variable] = mutableListOf(); binaryConstraints[variable] = mutableListOf()
        }
    ...
    companion object {
        ...
        private fun <VAR, DOMAIN> getSharedConstraints(
            x: VAR,
            y: VAR,
            allConstraints: Map<VAR, MutableList<LocalConstraint<VAR, DOMAIN>>>
        ): List<LocalConstraint<VAR, DOMAIN>> {
