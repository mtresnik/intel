...
class Dataset(val schema: Schema, val targetAttribute: Attribute<*>) : ArrayList<Entry>() {
    ...
    fun buildTree(): DecisionTree {
        ...
        val highestAttribute =
            getHighestGainAttribute() ?: throw IllegalStateException("All attributes have equal entropy.")
    ...
    fun getHighestGainAttribute(): Map.Entry<Attribute<*>, Double>? =
        getAllInformationGain().entries.maxByOrNull { entry -> entry.value }
