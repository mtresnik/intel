...
interface TensorLossFunction {
    ...
    fun lossDerivative(expected: ArrayVector, actual: ArrayVector) : ArrayTensor = lossDerivative(expected.values, actual.values)

    fun lossDerivative(expected: ArrayTensor, actual: ArrayTensor) : ArrayTensor = lossDerivative(expected.values, actual.values)
