...
open class PointQuadTree(bounds : PointQuadTreeRect) : AbstractQuadTree<PointQuadTreeRect, PointQuadTreeData, PointQuadTree>(bounds) {
    ...
    companion object {
        ...
        private fun createIfNonNull(rect : Rect?) : PointQuadTree? = if(rect != null) PointQuadTree(PointQuadTreeRect(rect)) else null
